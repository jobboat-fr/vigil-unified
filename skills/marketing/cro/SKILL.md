...
metadata:
  hermes:
    tags: [Marketing, CRO, Conversion, Experimentation]
    related_skills: [copywriting, analytics]
---
...
> **Routes to →** **Studio** + **Calculations** (experiment math); landing-page optimization.
