...
metadata:
  hermes:
    tags: [Marketing, Positioning, ICP, Context]
    related_skills: [copywriting, cro, launch, pricing]
---
...
> **Routes to →** The shared context doc every marketing skill reads first; positioning artifact in **Studio**; a marketing lens in the **Council**.
