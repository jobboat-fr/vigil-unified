// Shared canvas constants. Kept out of VigilNode.tsx so that file exports only
// its component (satisfies react-refresh/only-export-components and keeps Fast
